...
public interface Modules {
    Module[] MODULES = {
        new Module(
            ...
            new DriveControl(FrontRight.DRIVE_MOTOR), 
            new TurnControl(
        ...
        new Module(
            "Swerve/Front Left", 
            new Translation2d(+Settings.Swerve.SIZE.getX() / 2, +Settings.Swerve.SIZE.getY() / 2), 
            new DriveControl(FrontLeft.DRIVE_MOTOR),
            new TurnControl(
        ...
        new Module(
            "Swerve/Back Left", 
            new Translation2d(-Settings.Swerve.SIZE.getX() / 2, +Settings.Swerve.SIZE.getY() / 2), 
            new DriveControl(BackLeft.DRIVE_MOTOR),
            new TurnControl(
                BackLeft.TURN_MOTOR,
                BackLeft.ENCODER, 
        ...
        new Module(
            "Swerve/Back Right", 
            new Translation2d(-Settings.Swerve.SIZE.getX() / 2, -Settings.Swerve.SIZE.getY() / 2), 
            new DriveControl(BackRight.DRIVE_MOTOR),
            new TurnControl(
