...
public class TwoPieceMobilityNonWire extends SequentialCommandGroup {

    public TwoPieceMobilityNonWire() {
        ...
        PathPlannerTrajectory backtraj = PathPlanner.loadPath("TwoPieceMobilityNonwireBack", Motion.CONSTRAINTS);
